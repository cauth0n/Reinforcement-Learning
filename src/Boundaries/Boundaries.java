...
public interface Boundaries {
	 ...
	 * 
	 * @param state current state
	 * @param actionIndex action to apply to state
	 * 
	 ...
	 * 
	 * @param yOld starting point for y.
	 * @param yNew ending point for y.
	 * @param x value at which to check y's (pivot)
	 * 
	 ...
	 * 
	 * @param xOld starting point for x
	 * @param xNew starting point for y
	 * @param y value at which to check x's (pivot)
	 * 
	 ...
	 * @param yOld starting point for y
	 * @param yNew ending point for y
	 * @param xOld value at which to check y's (pivot)
	 * 
	 ...
	 * 
	 * @param xOld starting point for x
	 * @param xNew ending point for x
	 * @param yOld value at which to check x's (pivot)
	 * 
	 * @return true if a path, false otherwise.
	 */
